                           ...
                           ?>
                                ...
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-dashboard"></span> Admin <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <li><a href="index.php">Users <span class="glyphicon glyphicon-user"></span></a></li>
                                        <li><a href="../products/index.php">Products <span class="glyphicon glyphicon-apple"></span></a></li>
                                        <!--
                                 ...
                                 <?php
                                    ...
                                    else
                                    {
                                          while($item=mysqli_fetch_array($category_result)){
                                            ...
                                            {
                                            ?> 
                                                <li><a href="../../category_product.php?category=<?=$item['category']?>"><?=$item['category']?></li>
                                            <?php
                                            }
                                          }
                                          ?>
	      ...
	      <div class="modal-body">
	        <form action="" method="post">
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="name" value="" placeholder="Никнейм">
	        	</div>
				<div class="form-group">
	        		<input type="text" class="form-control" name="email" value="" placeholder="Почта">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="password" value="" placeholder="Пароль">
	        	</div>
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="contact" value="" placeholder="Номер Телефона">
	        	</div>
				<div class="form-group">
	        		<input type="text" class="form-control" name="city" value="" placeholder="Город">
	        	</div>
				<div class="form-group">
	        		<input type="text" class="form-control" name="address" value="" placeholder="Адрес">
	        	</div>
				<div class="form-group">
        		<input type="text" class="form-control" name="perms" placeholder="Уровень доступа" list="perms_list">
